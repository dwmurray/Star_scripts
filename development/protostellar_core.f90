...
contains
  ...
  function determine_rho_core(M, R, eps1, dphideps1)
    ...
    double precision             :: determine_rho_core
    double precision, intent(in) :: M, R, eps1, dphideps1
  ...
  function determine_P_core(M, R, n, dphideps1)
    ...
    double precision, intent(in) :: M, R, n, dphideps1
    double precision             :: determine_P_core
